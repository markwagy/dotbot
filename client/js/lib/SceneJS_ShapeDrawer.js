...
SceneJS_ShapeDrawer.prototype.addStartingPoint = function(x,y,z) {
    this.scene.findNode("startingPoint").add("node",
	{
	    nodes: [{
		type: "translate",
		id: "startTranslate",
...
SceneJS_ShapeDrawer.prototype.removeStartingPoint = function() {
    var n = this.scene.findNode("startTranslate");
    if (n != null) {
	n.destroy();
    }
};
...
SceneJS_ShapeDrawer.prototype.refreshStartPoint = function(x,y,z) {
    this.removeStartingPoint();
    this.addStartingPoint(x,y,z);
};
...
SceneJS_ShapeDrawer.prototype.add = function(body,shape, opts){
